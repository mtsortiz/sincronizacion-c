/*
    ...
    Los operarios no tienen ningún espacio para almacenar los componentes producidos pero 
    si tiene espacio para fabricar de a uno, y el Montador no podrá tomar
    ninguna pieza si esta no ha sido fabricada previamente por el correspondiente
    operario. 
*/
